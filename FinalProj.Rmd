...
author: "Marko Neskovic, Harshil Patel, and Jeffrey Qin"
date: "5/18/2020"
...
There are two teams that are in this dataset, the blue team and the red team, and the blue is the one we wish the analyze, with the red attributed only serving to calculate differences.
...
2. Using the data frame to plot the relationship between that factor and winrate, making sure to include a regression line in the plot
